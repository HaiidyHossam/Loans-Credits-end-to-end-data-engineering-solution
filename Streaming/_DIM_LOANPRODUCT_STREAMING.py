...
final_df = df.select("BORROWER_KEY_PK_SK","grade","sub_grade","term","purpose","initial_list_status","out_prncp","application_type","debt_settlement_flag","loanproduct_bk"
)
final_df = final_df.withColumnRenamed("BORROWER_KEY_PK_SK", "LOAN_PRODUCT_KEY_PK")
